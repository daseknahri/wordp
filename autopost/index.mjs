...
const {
  ...
  "Facebook helpers are not ready.",
  {
    ...
    resolveFacebookDistributionContext: "resolveFacebookDistributionContext",
    resolveFacebookDistributionResult: "resolveFacebookDistributionResult",
    resolveFacebookTargets: "resolveFacebookTargets",
