        ...
        <div class="archive-feed">
            <article class="archive-feed__lead">
                <a class="archive-feed__lead-media" href="<?php echo esc_url(get_permalink($lead_post)); ?>">
                    ...
                    <?php else : ?>
                        <?php kuchnia_twist_render_media_placeholder(kuchnia_twist_media_context_for_post($lead_post->ID), __('Search result image', 'kuchnia-twist')); ?>
                    <?php endif; ?>
                </a>
                ...
                <?php foreach ($feed_posts as $post_item) : ?>
                    <article class="archive-item">
                        <a class="archive-item__media" href="<?php echo esc_url(get_permalink($post_item)); ?>">
                            ...
                            <?php else : ?>
                                <?php kuchnia_twist_render_media_placeholder(kuchnia_twist_media_context_for_post($post_item->ID), __('Search result image', 'kuchnia-twist')); ?>
                            <?php endif; ?>
                        </a>
    ...
    <?php else : ?>
        <div class="search-rescue">
            <div class="search-rescue__copy">
                <p class="empty-state"><?php esc_html_e('No matching articles yet. Try a broader ingredient, a technique, or jump into a pillar to keep reading.', 'kuchnia-twist'); ?></p>
                <div class="chip-links">
                    <?php foreach (kuchnia_twist_pillar_nav_items() as $item) : ?>
                        <a class="chip-link" href="<?php echo esc_url($item['url']); ?>"><?php echo esc_html($item['label']); ?></a>
                    <?php endforeach; ?>
