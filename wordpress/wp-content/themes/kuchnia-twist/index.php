...
<section class="listing-header listing-header--feature">
    <div class="listing-hero">
        ...
        <aside class="listing-hero__panel">
            ...
            <span class="site-footer__eyebrow"><?php esc_html_e('Publication snapshot', 'kuchnia-twist'); ?></span>
    ...
    <?php else : ?>
        <div class="search-rescue">
            <div class="search-rescue__copy">
                <p class="empty-state"><?php esc_html_e('No posts yet. Your first published article will appear here once the journal begins publishing.', 'kuchnia-twist'); ?></p>
