...
?>
<?php kuchnia_twist_render_listing_header($context, __('Publication snapshot', 'kuchnia-twist')); ?>
<section class="story-grid" data-reveal>
    ...
    <?php else : ?>
        <?php kuchnia_twist_render_listing_empty_state(
            __('No posts yet. Your first published article will appear here once the journal begins publishing.', 'kuchnia-twist')
        ); ?>
    <?php endif; ?>
</section>
