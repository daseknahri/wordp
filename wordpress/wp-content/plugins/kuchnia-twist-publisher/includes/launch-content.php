...
function kuchnia_twist_launch_core_pages(): array
{
    return [
        'about' => [
            ...
            'content' => <<<'HTML'
<p>Kuchnia Twist is an English-language food journal shaped around warm home cooking, useful ingredient explainers, and slower story-led kitchen essays. It is edited by <strong>[kuchnia_twist_editor_name]</strong>, [kuchnia_twist_editor_role], and it is built to feel like a readable publication rather than a feed of disposable posts.</p>
<p>The idea behind the site is simple: food writing becomes more useful when it is organized with a little restraint. Readers should be able to understand what the publication is for within a few seconds, see who is behind it, and move easily between recipes, explainers, and reflective essays without landing in clutter. That is why the archive is deliberately narrow in shape even when the subject matter stays broad and domestic.</p>
<h2>What the journal publishes</h2>
<p>The archive stays focused on three editorial pillars so the site remains easy to understand and easy to trust as it grows.</p>
<ul>
...
<li><strong>Food Stories</strong> bring in reflection, rhythm, and publication voice so the site feels human instead of mechanical.</li>
</ul>
<p>Those pillars matter because a home-cooking publication does not earn trust through volume alone. It earns trust when readers can tell what kind of page they are opening and what sort of promise that page is making. A recipe should help someone cook. An explainer should make a technique or ingredient easier to understand. A story should deepen the archive rather than drift away from it. Keeping those jobs separate makes every article easier to judge on its own merits.</p>
<h2>Why this publication exists</h2>
<p>Good food sites do more than rank for search terms. They help people decide what to cook, understand why a method works, and feel like they are learning from a publication with standards. Kuchnia Twist is built around that slower idea of usefulness.</p>
...
<p>That also means resisting the habits that make many young blogs feel forgettable: generic introductions, inflated claims, and a publishing rhythm that values output over clarity. The site is better served by fewer pieces that feel specific, current, and editorially coherent than by a flood of interchangeable content. Home cooks notice when the writing respects their time, and they notice when it does not.</p>
<h2>How the site is run</h2>
<p>Every article is expected to be original, readable, and shaped for the home cook. Recipes should be practical, food facts should stay grounded, and story-led pieces should be clearly framed as publication-voice essays rather than borrowed authority.</p>
<p>The trust layer around the archive matters as much as the archive itself. About, Contact, Privacy, Cookie, and Editorial Policy pages stay visible because they explain how the site works, how readers can reach it, and how editorial standards are handled. Those pages are part of the reading experience, not decorative compliance notes hidden in the footer.</p>
<p>Kuchnia Twist is also designed to age well. Recipes can be clarified, explainers can be refined, and trust pages can be updated when the tooling or business model changes. A useful site should feel maintained in public, not only in private. That is why readers are always given a route to contact the editorial desk, point out an unclear detail, or ask for a correction.</p>
...
<p>They should also expect a publication that is transparent about change. Kuchnia Twist is not launching with display ads, affiliate links, or aggressive tracking tools. If those things are introduced later, the relevant policy pages will change with them rather than pretending the site has remained static. That is part of what it means to run a small publication responsibly.</p>
<p>If you want to understand how recipes are updated, how corrections are handled, or how commercial activity would be disclosed later, read the [kuchnia_twist_link slug="editorial-policy"]Editorial Policy[/kuchnia_twist_link]. If you need to get in touch, the [kuchnia_twist_link slug="contact"]Contact page[/kuchnia_twist_link] keeps a public editorial route visible.</p>
HTML,
        ],
        'contact' => [
            'title' => 'Contact',
            ...
            'content' => <<<'HTML'
<p>If you need to reach Kuchnia Twist about a recipe, a correction, a sourcing question, or a relevant partnership enquiry, this is the right place to do it. The public editorial inbox is <strong>[kuchnia_twist_editor_public_email]</strong>.</p>
<p>This publication is run like a small editorial desk rather than an anonymous content feed. That means useful messages are taken seriously, especially when they improve clarity, catch an error, or help the archive feel more trustworthy over time. Readers should not have to guess whether there is a real route back to the site owner. The route should stay visible on purpose.</p>
<h2>When to write</h2>
<ul>
...
<li>Relevant business, media, or partnership enquiries that fit the publication.</li>
</ul>
<p>If your note helps the site become clearer, more accurate, or easier to use, it belongs here. Good editorial contact pages are not only for problems. They are also for thoughtful reader feedback, small corrections, and practical questions that reveal where an article can be better than it was on first publication.</p>
<h2>Response expectations</h2>
<p>Kuchnia Twist is run as a small editorial publication, so the goal is a thoughtful reply within a few business days rather than an instant support queue. Messages that improve clarity, accuracy, or trust are treated as editorial work, not as an interruption.</p>
<p>That response window matters because it sets a reasonable expectation without pretending the site is a large media operation. A small publication can still be current, careful, and reachable. What matters is not instant automation but visible follow-through when a message deserves attention.</p>
<h2>Corrections and standards</h2>
<p>If a reader spots an unclear instruction, a misleading phrase, or a factual issue, that note helps strengthen the archive. The publication aims to fix practical errors quickly and update articles when clearer wording or better structure improves usefulness.</p>
<p>Kuchnia Twist treats corrections as part of maintaining the publication rather than as a reputational inconvenience. If a recipe step reads ambiguously, if an ingredient explanation is too loose, or if a food story blurs a line it should not blur, the site is better when that issue is acknowledged and improved. A healthy archive depends on that habit.</p>
<h2>Business and partnership notes</h2>
<p>Relevant partnership, licensing, or media requests are welcome when they fit the publication's food focus and editorial tone. The most useful enquiries are the straightforward ones: what you are asking for, why it fits the site, and what timing matters. If a separate business route is published later, it will sit alongside the editorial inbox rather than replacing it.</p>
...
HTML,
        ...
        'privacy-policy' => [
            ...
            'content' => <<<'HTML'
<p>This privacy policy explains what Kuchnia Twist collects at launch and what is not currently running on the site. At launch, the publication does not use newsletter tools, advertising tags, affiliate scripts, or third-party analytics platforms.</p>
<p>The goal of this page is to describe the site as it actually operates, not as a generic website might operate. Privacy language is most useful when it matches the real tools in use. Because Kuchnia Twist is launching in a lean state, the policy is correspondingly simple: the site serves pages, handles ordinary technical logs, and receives editorial messages, but it does not run a broader advertising or tracking stack at launch.</p>
...
<p>If you send an email to the public editorial address, the details you include in that message may be used to reply, handle a correction, or manage a legitimate editorial or business enquiry.</p>
<p>WordPress itself may also process limited technical information needed to support normal publishing and administration. That information is handled for site operation, moderation, and maintenance rather than for off-site profiling. The publication is not built around harvesting reader data as a business model.</p>
<h2>What the information is used for</h2>
<ul>
<li>To keep the website available and secure.</li>
<li>To respond to reader, editorial, and business messages.</li>
<li>To review and improve published content when a clarification or correction is needed.</li>
</ul>
<p>In practice, that means collected information is tied to site delivery and reader communication. If a technical log helps diagnose a problem, it is used for maintenance. If an email raises a correction, it is used to reply and improve the relevant article. The publication does not use launch-stage data to build advertising profiles, audience segments, or remarketing campaigns.</p>
<h2>What is not active at launch</h2>
<p>Kuchnia Twist is not launching with ad scripts, affiliate platforms, or non-essential measurement tools. If that changes later, this page will be updated before those tools become part of normal site operation.</p>
...
<p>Kuchnia Twist does not sell reader data. Technical information may still pass through ordinary hosting and infrastructure providers because that is part of delivering the site, but the publication itself is not structured around commercial data brokerage. Messages sent to the editorial desk may be retained for editorial follow-up, correction history, or legitimate business communication for as long as they remain practically useful.</p>
...
HTML,
        ...
        'cookie-policy' => [
            'title' => 'Cookie Policy',
            'content' => <<<'HTML'
<p>This cookie policy describes the limited cookie use associated with the site at launch. Kuchnia Twist is not launching with advertising cookies, affiliate scripts, or third-party analytics cookies.</p>
<p>As with the privacy policy, the purpose here is to reflect the real launch environment. Cookie notices often become unreadable because they describe every possible category whether the site uses it or not. Kuchnia Twist is starting more simply than that, so this page describes only the platform-level use that may be present now and what would change if the site adopts more tooling later.</p>
...
<p>The launch version of Kuchnia Twist does not rely on ad-tech cookies, tracking pixels, or external analytics platforms. If those systems are added later, this policy will be updated before they become part of the live site.</p>
...
HTML,
        ...
        'editorial-policy' => [
            ...
            'content' => <<<'HTML'
<p>Kuchnia Twist publishes food content that is meant to be useful, readable, and honest about what kind of piece it is. This policy explains the standards the journal applies across recipes, explainers, and story-led essays.</p>
<p>The point of an editorial policy is not to sound grander than the publication is. It is to make the house standards visible so readers know what the archive is trying to do and what it is trying to avoid. A smaller food site still benefits from stating how it handles clarity, corrections, updates, and commercial change. In practice, that means being plain about what each article type owes the reader.</p>
<h2>Recipes</h2>
...
<p>Recipe writing on Kuchnia Twist should respect a real kitchen. That means method steps should sound plausible, ingredient lists should support the dish rather than decorate it, and time estimates should aim to be useful rather than flattering. Readers should not have to reverse-engineer a recipe because the article prized atmosphere over structure.</p>
...
<h2>Food Facts</h2>
<p>Fact-led pieces should answer real kitchen questions without pretending to be scientific or medical authority. The publication avoids invented claims, shallow rewrites, and borrowed certainty used only to sound impressive.</p>
...
<h2>Food Stories</h2>
<p>Story-led pieces are publication-voice essays. They can be reflective and atmospheric, but they should not invent personal experience or imply first-hand reporting that did not happen. Narrative exists to deepen the archive, not to blur the line between voice and fact.</p>
<p>That distinction matters for trust. Kuchnia Twist uses essays to add texture, rhythm, and a broader editorial sensibility around home cooking, but those pieces should stay honest about what kind of voice they use. They can observe, reflect, and connect ideas. They should not manufacture autobiography, fabricated scenes, or false claims of access in order to sound intimate.</p>
<p>When a story-led piece works well, it gives readers a reason to stay with the publication beyond the recipe search. It should feel thoughtful, not manipulative; warm, not invented.</p>
<h2>Corrections and updates</h2>
<p>If a recipe instruction is unclear or a factual statement needs revision, the site should correct it promptly. Reader feedback that makes a post more accurate, more honest, or easier to cook from is treated as valuable editorial input.</p>
<p>Corrections are not framed here as exceptional embarrassment. They are part of responsible maintenance. If a post benefits from a clearer phrase, a corrected detail, or a better sequence, the archive improves when that change is made. A food site that expects to stay useful should behave like a living publication rather than a static dump of finished pages.</p>
<p>Where appropriate, updates may also be made to keep trust pages aligned with the site's actual tools and business model. Policies that no longer match the live site weaken the publication even when the articles themselves are strong.</p>
<h2>Commercial transparency</h2>
<p>Kuchnia Twist is not launching with display advertising, affiliate links, or sponsored content. If those arrangements are added later, they will be disclosed clearly so editorial trust remains easier to evaluate rather than harder.</p>
...
<p>Across all three pillars, readers can expect a tone that values specificity over filler and clarity over theatrical confidence. The site aims to feel maintained, reachable, and worth revisiting. That standard applies not only to post bodies but also to the trust pages, contact routes, and visible editorial framing around them.</p>
<p>If you want to raise a correction, ask a standards question, or understand how the publication is run, the [kuchnia_twist_link slug="contact"]Contact page[/kuchnia_twist_link] and [kuchnia_twist_link slug="about"]About page[/kuchnia_twist_link] remain part of the same public trust layer as this policy.</p>
HTML,
        ],
    ];
}
...
<p>It is also why recipes like this help establish trust in a food publication. The dish sounds plausible before you cook it, the method behaves as described, and the leftovers remain useful. Those are modest virtues, but they are the ones readers remember. Flashier promises fade quickly. Practical reliability does not.</p>
<h2>Keep reading</h2>
<p>If you like dinners that depend on patient browning rather than complicated technique, read [kuchnia_twist_link slug="why-onions-need-more-time-than-most-recipes-admit"]Why Onions Need More Time Than Most Recipes Admit[/kuchnia_twist_link]. For another calm weeknight option, try [kuchnia_twist_link slug="creamy-mushroom-barley-soup-for-busy-evenings"]Creamy Mushroom Barley Soup for Busy Evenings[/kuchnia_twist_link]. And if you want to see how the publication handles recipe updates and corrections, open the [kuchnia_twist_link slug="editorial-policy"]Editorial Policy[/kuchnia_twist_link].</p>
HTML,
            'recipe' => [
                'prep_time' => 'PT20M',
                'cook_time' => 'PT50M',
...
<h2>Why a soup like this builds editorial trust</h2>
...
<p>A dependable soup also reveals a publication's priorities. It shows whether the recipe values texture, sequencing, and realistic pacing or whether it is only dressed up to look substantial. When the bowl behaves as described, trust grows quietly. That is the kind of confidence a real archive is built on.</p>
<h2>Keep reading</h2>
<p>For a companion piece on why a soup pot earns so much loyalty in a real kitchen, read [kuchnia_twist_link slug="the-quiet-value-of-a-soup-pot-on-a-busy-weeknight"]The Quiet Value of a Soup Pot on a Busy Weeknight[/kuchnia_twist_link]. If you want another pantry-friendly dinner, try [kuchnia_twist_link slug="tomato-butter-beans-on-toast-with-garlic-and-lemon"]Tomato Butter Beans on Toast with Garlic and Lemon[/kuchnia_twist_link]. For publication standards around recipes, corrections, and updates, see the [kuchnia_twist_link slug="editorial-policy"]Editorial Policy[/kuchnia_twist_link].</p>
HTML,
            'recipe' => [
                'prep_time' => 'PT15M',
                'cook_time' => 'PT50M',
...
<p>That attitude matters in a real home kitchen. Some of the most useful dinners are not glamorous. They are simply the meals that can be made quickly from ordinary ingredients while still making the evening feel intact. A publication that wants to feel honest should make room for that kind of recipe rather than pretending every worthwhile dinner begins with a shopping list.</p>
...
<p>This is one reason pantry recipes matter so much in a publication archive. They reveal whether the site understands the meals readers make most often, not only the ones that look good in a hero image. A useful food journal should know how to make modest ingredients feel deliberate, because that is one of the skills home cooks return to most.</p>
...
<p>Seen that way, onions are almost an editorial principle as much as an ingredient. They reward clarity, punish haste, and improve the whole structure when they are handled honestly. That makes them exactly the sort of ordinary but powerful subject a strong food archive should keep explaining.</p>
...
<p>A publication earns trust when it notices and explains details like this. They are not glamorous, but they are the things readers actually carry back into dinner the next night.</p>
...
<h2>Keep reading</h2>
<p>You can see this in action in [kuchnia_twist_link slug="tomato-butter-beans-on-toast-with-garlic-and-lemon"]Tomato Butter Beans on Toast with Garlic and Lemon[/kuchnia_twist_link]. For another small technique that improves a surprising number of meals, read [kuchnia_twist_link slug="why-onions-need-more-time-than-most-recipes-admit"]Why Onions Need More Time Than Most Recipes Admit[/kuchnia_twist_link]. And for the publication's approach to fact-led food writing, open the [kuchnia_twist_link slug="editorial-policy"]Editorial Policy[/kuchnia_twist_link].</p>
HTML,
            'recipe' => ['prep_time' => '', 'cook_time' => '', 'total_time' => '', 'yield' => '', 'ingredients' => [], 'instructions' => []],
        ],
        [
...
<p>In the end, the soup pot matters because it makes a certain kind of humane dinner possible. It creates room for meals that are calm, layered, and generous without being grand. That is the kind of value a real home-cooking publication should know how to recognize.</p>
...
<p>That is why routines deserve a place in editorial food writing alongside recipes and ingredient notes. They are part of how meals actually happen. If a publication wants to sound credible about home cooking, it should know that confidence is often built from habits as much as from recipes.</p>
...
<p>Readers recognize that credibility quickly because it matches their own lives. They know dinner is shaped by repeated motions, not only by ingredients. When a publication acknowledges that, it starts sounding less like performance and more like company.</p>
<h2>Keep reading</h2>
<p>If you like this slower idea of usefulness, read [kuchnia_twist_link slug="the-quiet-value-of-a-soup-pot-on-a-busy-weeknight"]The Quiet Value of a Soup Pot on a Busy Weeknight[/kuchnia_twist_link]. For a practical pantry counterpart, open [kuchnia_twist_link slug="cooking-from-a-half-empty-fridge"]Cooking from a Half-Empty Fridge[/kuchnia_twist_link]. And if you want to see how the publication defines its story-led voice, open the [kuchnia_twist_link slug="editorial-policy"]Editorial Policy[/kuchnia_twist_link].</p>
HTML,
            'recipe' => ['prep_time' => '', 'cook_time' => '', 'total_time' => '', 'yield' => '', 'ingredients' => [], 'instructions' => []],
        ],
        [
...
<h2>Why this matters for a publication</h2>
<p>A recipe archive becomes trustworthy one piece at a time. If enough posts feel readable, plausible, and well kept, readers bring that trust with them to the next page. That is one reason the surrounding trust pages, correction routes, and editorial standards matter too: they tell the reader the site cares how its work lands.</p>
<p>A trustworthy archive is therefore cumulative. One solid recipe helps. Ten solid recipes, a visible correction path, and a coherent editorial voice help much more. Readers do not always articulate that calculation, but they feel it. The site either seems cared for or it does not.</p>
...
<p>In the end, a trustworthy recipe feels less like persuasion and more like guidance. It sounds like someone took the time to arrange the information well, tell the truth about the dish, and make the cook's work a little easier. For a publication, that is one of the most valuable impressions it can leave behind.</p>
<p>That impression is difficult to fake because it depends on alignment between tone, structure, and result. The site either follows through on its own promises or it does not. When it does, readers may not always describe the feeling in editorial language, but they sense it immediately and carry it forward to the next recipe.</p>
<p>That is why trust is one of the strongest forms of momentum a food publication can build. It brings readers back more effectively than exaggeration ever will. Once someone believes the archive is written with care, the next click comes more easily.</p>
<p>That return click is the quiet proof that trust has been earned. It means the recipe was not only readable on first glance, but useful enough in practice that the reader is willing to hand the site their attention again. Few editorial outcomes matter more than that.</p>
