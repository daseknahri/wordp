...
trait Kuchnia_Twist_Publisher_Rest_Publishing_Trait
{
    ...
    public function rest_publish_blog(WP_REST_Request $request)
    {
        ...
        $facebook_caption = isset($params['facebook_caption']) ? (string) $params['facebook_caption'] : $this->derive_legacy_facebook_caption($generated, $job);
        $group_share_kit = isset($params['group_share_kit']) ? (string) $params['group_share_kit'] : $this->derive_legacy_group_share_kit($generated);
