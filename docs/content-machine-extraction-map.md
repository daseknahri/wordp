...
- extract a posting-machine facade in the worker:
  - move WordPress job transport behind the same facade
...
- make plugin table names and site bootstrap behavior overridable
